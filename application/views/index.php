	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="<?=base_url('Indexcntrl')?>" class="nav-link">Home</a></li>
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="<?=base_url('Login')?>" class="btn btn-primary p-3 px-xl-4 py-xl-3">Reservation</a> <a href="<?=base_url('Menu')?>" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
	          ...
	          <div class="heading-section mb-4 text-center">
	            ...
	            <h2 class="mb-4">Appetizer Restaurant</h2>
						...
						<div class="video justify-content-center">
							<a href="<?=base_url('https://vimeo.com/45830194')?>" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
            ...
            <h2 class="mb-4">Our Master Chef</h2>
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
		                ...
		                <li class="ftco-animate"><a href="<?=base_url('#')?>"><span class="icon-google-plus"></span></a></li>
