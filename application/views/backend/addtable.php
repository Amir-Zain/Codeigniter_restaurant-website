					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Seats</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="<?=base_url('backend/Addtablecntrl/insert')?>" method="post">
										<div class="form-body">
											<div class="row">
											...
											<!-- <div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="projectinput6">Seats</label>
														<input type="text" name="table"  class="form-control" placeholder="1" value="1" readonly>
													</div>
												</div>
...
<div class="row">
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Status of seats</h4>
										...
										<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
											<div class="row">
												<div class="col-sm-12" style="overflow-x: auto;">
													<?php
  						$count = $this->db->query("SELECT COUNT(*) as available_seats FROM table_tb where status='Available'")->result(); 
                  foreach ($count as $key => $value3) { 
 $value3->available_seats;
}

?>

<?php
  						$count2 = $this->db->query("SELECT COUNT(*) as booked_seats FROM table_tb  where status='Booked' ")->result(); 
...
?>
<?php
  						$count3 = $this->db->query("SELECT COUNT(*) as total_seats FROM table_tb  ")->result(); 
                  foreach ($count3 as $key => $value) { 
 $value->total_seats;
}

?>
<h4>There are total <b><?php echo $value->total_seats; ?></b> Seats </h4>
<h4>Booked Seats= <b><?php echo $value2->booked_seats; ?></b>  </h4>
<h4>Available Seats= <b><?php echo $value3->available_seats; ?></b>  </h4>
