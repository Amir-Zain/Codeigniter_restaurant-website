					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Table</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="<?=base_url('backend/Addtimecntrl/insert')?>" method="post">
										<div class="form-body">
											<div class="row">

											<div class="col-md-6">
													<div class="form-group">
														<label for="projectinput6">Time</label>
														<select class="select2-B form-control" name="time" multiple="multiple">
												...
												<!-- <div class="col-md-6">
													<div class="form-group">
														<label for="projectinput6">Table & Seats</label>
														<select class="select2-B form-control" name="table" multiple="">
														
														<option value="Table-A(1 Seat)">Table-A(1 Seat)</option>
														<option value="Table-B(2 Seats)">Table-B(2 Seats)</option>
														<option value="Table-C(2 Seats)">Table-C(2 Seats)</option>
														<option value="Table-D(3 Seats)">Table-D(3 Seats)</option>
														<option value="Table-E(3 Seats)">Table-E(3 Seats)</option>
														<option value="Table-F(4 Seats)">Table-F(4 Seats)</option>
														<option value="Table-G(4 Seats)">Table-G(4 Seats)</option>
														<option value="Table-H(5 Seats)">Table-H(5 Seats)</option>
														<option value="Table-I(5 Seats)">Table-I(5 Seats)</option>
														<option value="Family(6 Seats)">Family(6 Seats)</option>
														<option value="Group(6 Seats)">Group(6 Seats)</option>
														</select>
													</div>
												</div> -->
													...
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 130px;">Time</th>

																<th class="sorting_asc" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 130px;">Status</th>
																
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 159px;">Delete</th>
															</tr>
														</thead>
														<tbody>
															...
															<tr role="row" class="odd">
																...
																<a href="<?=base_url('backend/Addtimecntrl/delete/'.$value->id)?>" onclick="return confirm('Are you sure want to delete this post?')"><span style="color:#fff;" class="btn btn-danger glyphicon glyphicon-trash" title="Delete post"></span></a> 
																</td>
															</tr>
															<?php
																}
