	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="<?=base_url('Fblog')?>" class="nav-link">Blog</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="<?=base_url('index.html')?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="<?=base_url('blog-single.html')?>" class="block-20" style="background-image: url('images/image_1.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="<?=base_url('#')?>">June 25, 2019</a></div>
                  <div><a href="<?=base_url('#')?>">Admin</a></div>
                </div>
                <h3 class="heading"><a href="<?=base_url('#')?>">Taste the delicious foods in Asia</a></h3>
                <p class="clearfix">
                  <a href="<?=base_url('#')?>" class="float-left read">Read more</a>
                  <a href="<?=base_url('#')?>" class="float-right meta-chat"><span class="icon-chat"></span> 3</a>
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="<?=base_url('blog-single.html')?>" class="block-20" style="background-image: url('images/image_2.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="<?=base_url('#')?>">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="<?=base_url('blog-single.html')?>" class="block-20" style="background-image: url('images/image_3.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="<?=base_url('#')?>">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="<?=base_url('blog-single.html')?>" class="block-20" style="background-image: url('images/image_4.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="<?=base_url('#')?>">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="<?=base_url('blog-single.html')?>" class="block-20" style="background-image: url('images/image_5.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="<?=base_url('#')?>">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="<?=base_url('blog-single.html')?>" class="block-20" style="background-image: url('images/image_6.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="<?=base_url('#')?>">June 25, 2019</a></div>
          ...
          <div class="col text-center">
            <div class="block-27">
              <ul>
                ...
                <li><a href="<?=base_url('#')?>">4</a></li>
                <li><a href="<?=base_url('#')?>">5</a></li>
                <li><a href="<?=base_url('#')?>">&gt;</a></li>
              </ul>
            </div>
          </div>
