        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="<?=base_url('Freservation')?>" class="btn btn-primary p-3 px-xl-4 py-xl-3">Reservation</a> <a href="<?=base_url('Fmenu')?>" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
