  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="<?=base_url('index.html')?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="<?=base_url('blog.html')?>">Blog <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog Single<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
            ...
            <p>
              <img src="<?=base_usrl('images/image_2.jpg')?>" alt="" class="img-fluid">
            </p>
            ...
            <div class="tag-widget post-tag-container mb-5 mt-5">
              <div class="tagcloud">
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Food</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Wine</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Drink</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Dish</a>
              </div>
            </div>
            
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="<?=base_usrl('images/person_1.jpg')?>" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="<?=base_usrl('images/person_1.jpg')?>" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>John Doe</h3>
                    <div class="meta mb-2">June 26, 2019 at 2:21pm</div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur quidem laborum necessitatibus, ipsam impedit vitae autem, eum officia, fugiat saepe enim sapiente iste iure! Quam voluptas earum impedit necessitatibus, nihil?</p>
                    <p><a href="<?=base_url('#')?>" class="reply">Reply</a></p>
                  </div>
                </li>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
            	<h3>Category</h3>
              <ul class="categories">
                <li><a href="<?=base_url('#')?>">Breakfast <span>(6)</span></a></li>
                <li><a href="<?=base_url('#')?>">Lunch <span>(8)</span></a></li>
                <li><a href="<?=base_url('#')?>">Dinner <span>(2)</span></a></li>
                <li><a href="<?=base_url('#')?>">Desserts <span>(2)</span></a></li>
                <li><a href="<?=base_url('#')?>">Drinks <span>(2)</span></a></li>
                <li><a href="<?=base_url('#')?>">Wine <span>(2)</span></a></li>
              </ul>
            </div>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="<?=base_url('#')?>">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="<?=base_url('#')?>"><span class="icon-calendar"></span> June 25, 2019</a></div>
                    <div><a href="<?=base_url('#')?>"><span class="icon-person"></span> Dave Lewis</a></div>
                    <div><a href="<?=base_url('#')?>"><span class="icon-chat"></span> 19</a></div>
                  </div>
                </div>
              </div>
              <div class="block-21 mb-4 d-flex">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <ul class="tagcloud m-0 p-0">
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Dish</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Food</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Lunch</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Menu</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Dessert</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Drinks</a>
                <a href="<?=base_url('#')?>" class="tag-cloud-link">Sweets</a>
              </ul>
            </div>
            ...
            <div class="sidebar-box ftco-animate">
            	<h3>Archives</h3>
              <ul class="categories">
              	<li><a href="<?=base_url('#')?>">January 2019 <span>(20)</span></a></li>
              	<li><a href="<?=base_url('#')?>">December 2018 <span>(30)</span></a></li>
              	<li><a href="<?=base_url('#')?>">Novemmber 2018 <span>(20)</span></a></li>
                <li><a href="<?=base_url('#')?>">September 2018 <span>(6)</span></a></li>
                <li><a href="<?=base_url('#')?>">August 2018 <span>(8)</span></a></li>
              </ul>
            </div>
