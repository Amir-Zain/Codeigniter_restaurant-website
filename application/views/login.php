      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="<?=base_url('index.html')?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Login<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
            ...
            <br>
						<h2 class="h4 mb-5 font-weight-bold">Login</h2>
						<form action="<?=base_url('Logincntrl/login')?>" method="post">
              ...
              <div class="form-group">
                ...
                &nbsp;&nbsp;<a href="<?=base_url('Signup')?>" class="btn btn-primary py-3 px-5">Sign Up</a>
              </div>
            </form>
					</div>
